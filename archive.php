			...
			<div class="container-fluid" id="postwrapper">
				...
				<?php if(is_paged()) :  ?>
					<div class="row text-center ajax-button">
						<a class="store-btn store-load-more" data-prev = "1" data-page="<?php echo store_check_paged(1); ?>" data-archive="<?php echo bzbr001_grab_current_uri(); ?>" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
				...
				<?php endif; ?>
					...
					<div class="row text-center ajax-button">
						<a class="store-btn store-load-more" data-page="<?php echo store_check_paged(1); ?>" data-archive="<?php echo bzbr001_grab_current_uri(); ?>" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
							<span class="fa fa-refresh"></span>
